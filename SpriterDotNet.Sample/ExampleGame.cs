...
namespace SpriterDotNet.Example.MonoGame
{
    public class ExampleGame : Game
    {
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            if (WasPressed(Keys.H)) animator.ChangeAnimationSpeed(-0.2f, 5.0f);
            if (WasPressed(Keys.J)) animator.ChangeAnimationSpeed(0.2f, 5.0f);
            ...
            if (WasPressed(Keys.K)) animator.PushNextCharacterMap();
            if (WasPressed(Keys.L)) animator.PopCharacterMap();
            if (WasPressed(Keys.C)) animator.Color = animator.Color == Color.White ? Color.Red : Color.White;
            ...
            if (WasPressed(Keys.O)) (animator as MonoGameDebugAnimator).DrawSpriteOutlines = !(animator as MonoGameDebugAnimator).DrawSpriteOutlines;
